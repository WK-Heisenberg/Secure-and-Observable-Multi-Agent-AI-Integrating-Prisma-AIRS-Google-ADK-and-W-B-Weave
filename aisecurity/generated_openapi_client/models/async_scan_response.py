...
class AsyncScanResponse(BaseModel):
    ...
    received: datetime = Field(description="Asynchronous scan received timestamp")
    scan_id: StrictStr = Field(description="Unique identifier for the asynchronous scan request")
