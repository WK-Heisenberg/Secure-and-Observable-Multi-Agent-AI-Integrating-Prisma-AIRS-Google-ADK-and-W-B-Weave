...
from aisecurity.generated_openapi_client.asyncio import rest
from aisecurity.generated_openapi_client.asyncio.api_response import (
    ApiResponse,
)
from aisecurity.generated_openapi_client.asyncio.api_response import (
    T as ApiResponseT,
...
from aisecurity.generated_openapi_client.asyncio.exceptions import (
    ApiException,
    ApiValueError,
)
...
class ApiClient:
    ...
    def __init__(self, configuration=None, header_name=None, header_value=None, cookie=None) -> None:
        ...
        self.user_agent = "Prisma-AIRS-Multi-Agent-Demo/1.0.0/python"
    ...
    def __deserialize(self, data, klass):
        ...
        if isinstance(klass, str):
            ...
            if klass in self.NATIVE_TYPES_MAPPING:
                ...
                klass = getattr(aisecurity.generated_openapi_client.models, klass)
    ...
    def select_header_accept(self, accepts: List[str]) -> Optional[str]:
        ...
        for accept in accepts:
            if re.search(r"json", accept, re.IGNORECASE):
                return accept
    ...
    def select_header_content_type(self, content_types):
        ...
        for content_type in content_types:
            if re.search(r"json", content_type, re.IGNORECASE):
                return content_type
